...
import { CalendarDays, Loader2, Megaphone, Sparkles } from "lucide-react";

import { PlanFeatureGuard } from "../../components/billing/PlanFeatureGuard";
import { DashboardLayout } from "../../components/dashboard/DashboardLayout";
import { useCurrentPlan } from "../../hooks/useCurrentPlan";
import { canUseSocialStudio } from "../../lib/planAccess";
...
function SocialStudioPage() {
  ...
  return (
    ...
    >
      <PlanFeatureGuard
        allowed={canUseSocialStudio(planSlug)}
        requiredPlan="Business"
        title="Social Studio disponível no plano Business"
        description="O Social Studio é um recurso avançado para criação, organização e planejamento de conteúdos. Faça upgrade para o plano Business para liberar."
      >
